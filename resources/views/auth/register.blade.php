<x-layout>
    ...
    <div class="card bg-base-100  max-w-sm  mx-auto shadow-md">
        <form class="fieldset bg-base-200 border-base-300 rounded-box w-sm border p-4" method="POST" action="/register">
            @csrf
            <label class="fieldset">
                <label class="label">Name</label>
                <input type="name" name="name" class="input validator" placeholder="John Smith" required />
            ...
            <label class="fieldset">
                ...
                <input type="password" name="password_confirmation" class="input validator" placeholder="Confirm Password" required />
                <span class="validator-hint hidden">Required</span>
            </label>
